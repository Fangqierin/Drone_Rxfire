...
def backtracking_list(memory, diameter, matrix, x, y):
...
#     cond_a = np.int0(is_valid_eight["t"] & ~is_valid_eight["tr"])
#     cond_b = np.int0(is_valid_eight["t"] & ~is_valid_eight["tl"])
#     cond_c = np.int0(is_valid_eight["b"] & ~is_valid_eight["bl"])
#     cond_d = np.int0(is_valid_eight["b"] & ~is_valid_eight["tl"])
    ...
    #print(f"to see what is this: {is_valid_eight} {μ_of_s} ")
