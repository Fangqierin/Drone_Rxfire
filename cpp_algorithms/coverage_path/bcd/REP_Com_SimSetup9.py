...
if __name__ == "__main__":
    ...
    for wind in [10]:#[5,10,15]:#[20,25]:#[15]:
        for time in [10]:#[1,20, 40,60]:
            for seed in range(10):
                ...
                foldername=f"REP_FQ_Tmp_U3_{wind}_{time}_{seed}"
                #CreateDyRxfire(Bardata,fir_name,dir, [2],wind=wind)
                CreateRandomRxfire(Bardata,fir_name,dir, [0],wind=wind,sed=seed,Inputdict=Inputdict,Offset=50)
                print(f"Finish create fire in Unit 3 wind: {wind} seed: {seed}")  
                '''
