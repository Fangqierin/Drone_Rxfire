...
def TrackDraw(Drones,EFAM, Only=-1):
...
####################################################################################  
    ...
    #     return inUT, inInter, WSeq # improve UT
    #
    # def Get_InterCsot(self, g):
    #     m=g[0]
    #     if len(self.FoVinfo.get(m))==0:
    #         return 10000000000000
    #     inUT,inInter,_=self.Get_Inter_UT(g)
...
def Auction_WPC(AreaPara, Drones, Res,Missions, seed, EFAM, GCloc):
